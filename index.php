    ...
    <span class="sr-only">Next</span>
					...
					<div class="container">
						<div class="row">
							<div class="col-sm-12">
								<h1 class="text-white">
									Hello, I'm Nirjon Roy.<br>I can create&nbsp;<span>beautiful Web Application</span>&nbsp;for you.</h1>
							</div>
						</div>
				...
				<div class="container">
					...
					<div class="col-md-6 col-sm-12">
							<div class="skills-right skills">
								...
								<ul class="skills-ul">
									<li>
								<span>HTML & CSS3 &nbsp(in Advanced) </span>
									<div class="progress">
  				<div class="progress progress-striped active">
  							<div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 80%;">
   								 80%
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center">
							<h1 style="background:gray">Check out my latest projects</h1>
							<p class="lead">
					...
					<div class="projects-container">
						...
						<div class="col-md-6 col-sm-12 no-pad project development image-holder">
							<div class="background-image-holder">
								<img class="background-image" alt="Background Image" src="project/calculator.jpg">
							</div>
							<div class="hover-state">
								<div class="align-vertical">
									<h1 class="text-white"><strong>Project 1</strong>&nbsp;JavaScript Calculator</h1>
									<p class="text-white"></p>
									<a href="project/calcultor/cal.html" class="btn btn-primary btn-white">See Project</a>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6 col-sm-12 no-pad project development image-holder">
							<div class="background-image-holder">
								<img class="background-image" alt="Background Image" src="project/digital clock.JPG">
							</div>
							<div class="hover-state">
								<div class="align-vertical">
									<h1 class="text-white"><strong>Project 2</strong>&nbsp;</h1>
									<p class="text-white">Digital Clock</p>
									<a href="project/digital clock.html" class="btn btn-primary btn-white">See Project</a>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4 col-sm-6 no-pad project print image-holder">
							...
							<div class="hover-state">
								<div class="align-vertical">
									<h1 class="text-white"><span>Project 3&nbsp;</span>Result Management System</h1>
									<p class="text-white"></p>
						...
						<div class="col-md-4 col-sm-6 no-pad project branding image-holder">
							<div class="background-image-holder">
								<img class="background-image" alt="Background Image" src="project/ballc.jpg">
							</div>
							<div class="hover-state">
								<div class="align-vertical">
									<h1 class="text-white"><strong>Project 4</strong></h1>
									<p class="text-white">Javascript Animation</p>
									<a href="project/ani.html" class="btn btn-primary btn-white">See Project</a>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4 col-sm-6 no-pad project print image-holder">
							<div class="background-image-holder">
								<img class="background-image" alt="Background Image" src="project/new.jpg">
							</div>
							<div class="hover-state">
								<div class="align-vertical">
									<h1 class="text-white"><span>Project 5&nbsp;</span>Photoshop Work</h1>
									<p class="text-white">Photo Edit</p>
									<a href="project/new.jpg" class="btn btn-primary btn-white">See Project</a>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-12">
							<div class="timeline-event">
								<div class="col-sm-6 col-md-push-6">
									<h2>Now</h2>
									<h5>Junior Instractor at Sylhet Jubo unnon Inistitute of Technology<br></h5>
								</div>
								...
								<div class="col-sm-6 col-md-pull-6">
									<p>
										I am  a Computer Instructor at Sylhet Jubo Unnon in Chowhatta, Sylhet-3100. </p>
								</div>
